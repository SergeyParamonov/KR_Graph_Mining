...
\matthias{This is the procedural tie-in code.}
...
\matthias{These are the negative constraints (negative homomorphism property and isomorphism restriction) expressed in idp}
