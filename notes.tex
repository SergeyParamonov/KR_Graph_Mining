...
\begin{lstlisting}[mathescape,caption=Higher Order predicate.,label=lst:HOPred]
...
A more workable solution would be to represent each characteristic property, such as the edge relation, by a single general relation for all graphs, as shown in Listing~\ref{lst:indexedglobal}.
