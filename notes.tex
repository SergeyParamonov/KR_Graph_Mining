...
%It retains the local coherence of graph characteristics where it comes to data representation, but prohibits the abstraction(generalisation) of knowledge about these properties, as evidenced by requiring us to duplicate the theory for erach graph.
