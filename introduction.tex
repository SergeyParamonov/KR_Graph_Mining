...
On the other hand, specification languages such as Alloy~\citep{tosem/Jackson02}, B, TLA~\citep{books/aw/Lamport2002}, VDM and Z, that support state-based and machine-based formal methods typically extend predicate logic with sets and operators from relational algebra, offering higher order semantics.
