...
On the other hand, specification languages such as Alloy~\citep{tosem/Jackson02}, Event-B~\citep{} and TLA~\citep{books/aw/Lamport2002}, that support state-based and machine-based formal methods typically extend predicate logic with sets and operators from relational algebra, offering higher order semantics.
ProB~\citep{journals/sttt/LeuschelB08} is such a well-know system for Event-B.
