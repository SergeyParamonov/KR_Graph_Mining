...
Declarative programming distinguishes itself by the ease with which declarative specifications are adapted to new requirements or changed circumstances, e.g. variations in which subproblems are used, and in the way they are combined.
