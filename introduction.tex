...
In recent years, focus has shifted from unstructured towards structured mining, such as graph or sequence mining \citet{cp_sequence_mining,rennes_asp_sequences}.
