% NOGOODS_BEGIN
 ...
 :- invar(1),invar(8),invar(9),invar(10),invar(11).
 :- invar(1),invar(8),invar(9),invar(10),invar(11).
 :- invar(10),invar(11),invar(12),invar(13),invar(14).
 :- invar(12),invar(13),invar(15),invar(14),invar(16).
 :- invar(10),invar(11),invar(12),invar(13),invar(14).
 :- invar(10),invar(11),invar(12),invar(15),invar(16).
 :- invar(10),invar(11),invar(12),invar(15),invar(16).
 :- invar(12),invar(13),invar(15),invar(14),invar(16).

 :- invar(9),invar(10),invar(11),invar(12),invar(15).
 :- invar(9),invar(10),invar(11),invar(12),invar(13).
 :- invar(8),invar(9),invar(10),invar(11),invar(12).

 :- invar(1),invar(6),invar(8),invar(9),invar(10).
 :- invar(1),invar(2),invar(8),invar(9),invar(10).

 :- invar(1),invar(2),invar(8),invar(3),invar(17).
 :- invar(1),invar(6),invar(8),invar(5),invar(17).

 :- invar(8),invar(9),invar(17),invar(10),invar(11).

 :- invar(1),invar(6),invar(2),invar(8),invar(5).
 :- invar(1),invar(6),invar(2),invar(8),invar(5).
 :- invar(1),invar(6),invar(2),invar(8),invar(3).
 :- invar(1),invar(6),invar(2),invar(8),invar(3).
 ...
 :- invar(1),invar(6),invar(2),invar(3),invar(5).
 :- invar(1),invar(2),invar(8),invar(3),invar(4).
 :- invar(1),invar(6),invar(2),invar(3),invar(4).
 :- invar(1),invar(6),invar(8),invar(4),invar(5).
 ...
 :- invar(1),invar(6),invar(2),invar(8),invar(17).
 :- invar(1),invar(6),invar(2),invar(8),invar(17).

 :- invar(1),invar(6),invar(8),invar(5),invar(9).
 :- invar(1),invar(6),invar(4),invar(5),invar(7).
 :- invar(1),invar(2),invar(8),invar(3),invar(9).
