...
As can be seen from Table~\ref{tbl:conclusion}, \todo{Provide an explanation of the table, with some references to earliers parts of the text to justify certain claims/results}
