...
\end{center}
\caption{Evaluation of the desirable properties in IDP / ASP / ProB\label{tbl:conclusion} for modelling the general graph mining problem based on its key components (matching, pattern enumeration, etc)}
\end{table}
